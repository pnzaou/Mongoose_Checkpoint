...
const verifyToken = (req, res, next) => {
    ...
    const extractToken = token.split(' ')[1]//ICI ON TRANSFORME LE TOKEN EN UN TABLEAU DE TAILLE 2 ['BEARER', 'NOTRE TOKEN'] ET ON EXTRAIT NOTRE TOKEN A L'INDICE 1 DU TABLEAU
